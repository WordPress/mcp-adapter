...
- ✅ Targets [MCP 2025-11-25 HTTP transport](https://modelcontextprotocol.io/specification/2025-11-25/basic/transports.md) baseline
- ✅ Supports both WordPress REST API and JSON-RPC 2.0 formats
- ⚠️ Streaming responses (SSE) are not yet implemented (GET currently returns 405)
