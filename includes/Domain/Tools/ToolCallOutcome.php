...
/**
 * Carries a completed tool result before protocol-specific DTO encoding.
 *
 * Content blocks remain plain arrays so the encoder can hydrate the selected
 * exact-revision DTO tree at the transport serialization boundary.
 *
 * @internal
 * @since n.e.x.t
 */
